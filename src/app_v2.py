...
def render_step_4():
    ...
    with col1:
        game_name = st.text_input("Game Name", value=analysis.game_name)
        hook_text = st.text_input("Hook Text", value=analysis.hook_suggestion)
        cta_text = st.text_input("CTA Text", value=analysis.cta_suggestion)
